# Generated by Django 3.2.4 on 2023-06-12 00:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_registered', models.DateField(default=datetime.datetime(2023, 6, 12, 0, 32, 13, 664324, tzinfo=utc))),
            ],
        ),
        migrations.CreateModel(
            name='Product',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_date', models.DateField(default=datetime.datetime(2023, 6, 12, 0, 32, 13, 665310, tzinfo=utc))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(default='No description')),
                ('cake_description', models.CharField(default='Not a cake!', max_length=400)),
                ('create_date', models.DateField(default=datetime.datetime(2023, 6, 12, 0, 32, 13, 664324, tzinfo=utc))),
                ('cartproduct', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='home.product')),
